...
$(function() {
    ...
    var graphP = $.ajax({
        url: './data.json', //index.php/... aufrufen?
        type: 'GET',
        dataType: 'json'
    });
   ...
   function getFadePromise(ele, opacity) {
    ...
    function showNodeInfo(node) {
        $('#info').html(infoTemplate(node.data())).show(); //Ergebis von Suche?
    }
    ...
    $('#filters').on('click', 'input', function() {
        ...
        var professor = $('#professor').is(':checked');
        ...
        cy.batch(function() {
            ...
            allNodes.forEach(function(n) {
                ...
                if (type === 'Cheese' || type === 'CheeseType') {
                    ...
                    var cType = n.data('Type'); //Verbindung zur Datenbank um Filtern zu können
