...
'
 ...
 ' um die Stopwords zu aktivieren bitte den folgenden Block aktivieren
 '----------------------------------------------------------------------------------------------------
 
 
 'Workbooks("csvErstellung.xlsm").Activate
 'Sheets("Stopwords").Select
  '  Sheets("Stopwords").Copy After:=Workbooks("dtm.csv").Sheets(1)
  
 'Workbooks("dtm.csv").Activate
 'Sheets("dtm").Select
'Sheets("Stopwords").Select
